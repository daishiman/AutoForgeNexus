...
- **選定理由**: データエンジニアリング専門家、Locke Data 創業者、R/Python/SQL での ETL 実装の第一人者
- **専門性**:
  - 大規模データ移行プロジェクトの経験
  - オープンソース ETL ツールの活用
  - データパイプライン自動化
...
- **選定理由**: 「Designing Data-Intensive Applications」著者、分散システムとデータ処理の専門家
- **専門性**:
  - 分散データシステムの設計
  - イベントソーシングと CDC
  - データレプリケーション戦略
...
- **選定理由**: Data Engineering Podcast 主催者、実践的なデータエンジニアリングの専門家
- **専門性**:
  - モダンデータスタックの構築
  - DataOps の実践
  - リアルタイムデータパイプライン
...
- **活用ポイント**:
  ...
  - インシデント対応計画
- **本プロジェクトへの適用**:
  - PostgreSQL から pgvector への安全な移行
  - ブルーグリーンデプロイメントでの移行
  - 移行ロールバック戦略
