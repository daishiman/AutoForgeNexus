...
/* クリーンアーキテクチャとDDDの実践 - AutoForgeNexus構造準拠 */
...
/* API設計のベストプラクティス - AutoForgeNexus構造準拠 */
- エンドポイント設計
  - presentation/api/v1/{機能名}/でのルーター配置
  - router.py: ルート定義
...
/* AutoForgeNexus Infrastructure層構造 */
